...
sales_by_year_cat_2_tbl %>%
    ...
    labs(
        ...
        subtitle = "Each prodduct category has an upward trend",
        x = "",
        y = "Revenue",
...
fs::dir_create("00_data/bike_sales/data_wrangles_student")

# 7.1 Excel ----
bike_orderlines_wrangled_tbl %>%
    write_xlsx("00_data/bike_sales/data_wrangles_student/bike_orderlines.xlsx")

# 7.2 CSV ----
bike_orderlines_wrangled_tbl %>%
    write_csv("00_data/bike_sales/data_wrangles_student/bike_orderlines.csv")

# 7.3 RDS ----

bike_orderlines_wrangled_tbl %>%
    write_rds("00_data/bike_sales/data_wrangles_student/bike_orderlines.rds")
